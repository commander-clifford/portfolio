<header class="work-header">
	<h1 class="work-header-headline heading-typ-1">Logistics Portal</h1>
	<p class="work-header-subheadline">
		a landing page for Military logistics tools
	</p>
</header>
	...
	<div class="col-xs-12 col-md-8">
		<div class="work-content-display">
			...
			<div class="button-row row">
				<a class="button left" href="/IBM/portal/" target="_blank">View Project</a>
			</div>
		</div>
	</div>
